                                    ...
                                    @if ($trendingOne)
                                        <div class="trend-top-img">
                                            <img src="{{ $trendingOne->gambar_base64 ? $trendingOne->gambar_base64 : ($trendingOne->gambar ? asset('storage/' . $trendingOne->gambar) : 'https://via.placeholder.com/800x800?text=No+Image') }}"
                                                alt="{{ $trendingOne->judul }}" loading="lazy">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="single-bottom mb-35">
                                                    <div class="trend-bottom-img mb-30">
                                                        <img src="{{ $item->gambar_base64 ? $item->gambar_base64 : ($item->gambar ? asset('storage/' . $item->gambar) : 'https://via.placeholder.com/800x800?text=No+Image') }}"
                                                            alt="" class="square-img" loading="lazy">
                                                    </div>
                                                    <div class="trend-bottom-cap">
                                                        <span
                                                            class="color1">{{ $item->kategori->nama ?? 'Tidak masuk kategori' }}</span>
                                                        <h4><a
                                                                href="{{ route('web.show', $item->slug) }}">{{ $item->judul }}</a>
                                                        </h4>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="list-group mb-4">
                                        @foreach ($trending as $trend)
                                            <a href="{{ route('web.show', $trend->slug) }}"
                                                ...
                                                @endif
                                                <div class="flex-fill">
                                                    <h6 class="mb-2" style="margin-left: 10px;">
                                                        {{ Str::limit($trend->judul, 50) }}</h6>
                                                </div>
                                            </a>
                                        @endforeach
                                    </div>
                                        ...
                                        <nav>
                                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                ...
                                                @foreach ($kategoriList as $kat)
                                                    <a href="{{ route('web.kategori', $kat->id) }}"
                                                        class="nav-item nav-link js-whats-new-filter"
                                ...
                                <div class="single-box">
                                    <div class="follow-us d-flex align-items-center">
                                        <div class="follow-social">
                                            <a href="https://web.facebook.com/profile.php?id=61591466745591"><img
                                    ...
                                    <div class="follow-us d-flex align-items-center">
                                        <div class="follow-social">
                                            <a href="https://www.tiktok.com/@merahputihpers?_r=1&_t=ZS-97syyYINYkj"><img
                                                    src="assets/img/news/icon-ttk.png" alt=""></a>
                                        </div>
                                        <div class="follow-count">
                                            <span>Folow link</span>
                                            {{-- <p>Fans</p> --}}
                                    ...
                                    <div class="follow-us d-flex align-items-center">
                                        <div class="follow-social">
                                            <a href="https://www.instagram.com/merahputihpers/"><img
                                    ...
                                    <div class="follow-us d-flex align-items-center">
                                        <div class="follow-social">
                                            <a href="https://youtube.com/@merahputihpers?si=77bFZCJNvwc0HanN"><img
