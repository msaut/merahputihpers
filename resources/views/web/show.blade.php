...
@section('og_meta')
    @php
        ...
        if ($berita->gambar) {
            $imgPath = Str::startsWith($berita->gambar, 'berita/') ? $berita->gambar : 'berita/' . $berita->gambar;
    ...
    @php
        $organizationSchema = [
            ...
            'sameAs' => ['https://facebook.com/merahputihpers', 'https://instagram.com/merahputihpers'],
        ];
    @endphp
        ...
        $breadcrumbSchema = [
            ...
            'itemListElement' => [
                ...
                [
                    ...
                    'position' => 2,
                    'name' => $kategoriNama,
                    'item' => url('/kategori/' . $berita->kategori->slug ?? '#'),
                ],
                [
                    '@type' => 'ListItem',
                    'position' => 3,
...
@section('content')
    ...
    <div class="container mt-10">
        ...
        <img src="{{ $displayImage }}" alt="{{ $berita->judul }}" loading="lazy"
            style="
            width:100%;
            max-width:800px;
            height:auto;
